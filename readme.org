...
- Customization of the desktop directory name
  ...
  - If you change location the project, it becamos incompatible and cannot be reused.
...
This package does not make any hook/advice for project.el or other package. So if you are using [[https://github.com/emacs-dashboard/dashboard][emacs-dashboard]], will occur problem to open project from dashboard.
